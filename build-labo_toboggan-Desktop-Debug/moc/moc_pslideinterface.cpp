...
#include "../../code/src/pslideinterface.h"
...
void PSlideInterface::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<PSlideInterface *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        case 2: _t->sig_goToPlayground((*reinterpret_cast< uint(*)>(_a[1])),(*reinterpret_cast< uint(*)>(_a[2]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (PSlideInterface::*)(unsigned int , QString );
        ...
        {
            using _t = void (PSlideInterface::*)(unsigned int , unsigned int , unsigned int );
        ...
        {
            using _t = void (PSlideInterface::*)(unsigned int , unsigned int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&PSlideInterface::sig_goToPlayground)) {
                *result = 2;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject PSlideInterface::staticMetaObject = { {
    ...
    qt_meta_stringdata_PSlideInterface.data,
    qt_meta_data_PSlideInterface,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
// SIGNAL 2
void PSlideInterface::sig_goToPlayground(unsigned int _t1, unsigned int _t2)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(&_t1)), const_cast<void*>(reinterpret_cast<const void*>(&_t2)) };
